  ...
  fighter({
    ...
    passiveEffects: [
      definePassive({
        ...
        description: 'Junpei takes additional damage from all sources.',
    ...
    abilities: [
      skill({
        ...
        description: 'Deals 10 damage and poisons one enemy for 2 turns.',
        kind: 'attack',
        targetRule: 'enemy-single',
      ...
      skill({
        ...
        description: 'The next time the target uses a skill, they are stunned and take 15 affliction damage.',
        kind: 'debuff',
        targetRule: 'enemy-single',
        classes: ['Affliction', 'Ranged', 'Instant'],
        cooldown: 2,
      ...
      skill({
        ...
        name: 'Toxic Break',
        description: 'Deals 20 damage. Injected targets take 15 more piercing damage and become more vulnerable to affliction.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Affliction', 'Ranged', 'Instant'],
        cooldown: 2,
    ...
    ultimate: defendSkill({
      ...
      description: 'Junpei becomes invulnerable for 1 turn and counters the next harmful skill.',
      targetRule: 'self',
      classes: ['Strategic', 'Instant', 'Ultimate'],
      cooldown: 4,
      duration: 1,
      ...
      effects: [
        { type: 'invulnerable', duration: 1, target: 'self' },
        { type: 'counter', duration: 1, counterDamage: 15, consumeOnTrigger: true, target: 'self' },
      ],
    }),
  }),
  fighter({
  ...
  fighter({
    ...
    passiveEffects: [
      definePassive({
        ...
        trigger: 'onAbilityResolve',
        effects: [{ type: 'damage', power: 5, target: 'self', piercing: true }],
        label: 'Vocal Strain',
        description: 'Each time Toge uses a skill, he takes 5 affliction damage.',
    ...
    abilities: [
      skill({
        id: 'toge-dont-move',
        name: "Don't Move.",
        description: 'Deals 20 damage and reduces the target’s non-affliction damage for 1 turn.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Special', 'Ranged', 'Instant'],
        cooldown: 1,
      ...
      skill({
        id: 'toge-blast-away',
        name: 'Blast Away',
        description: 'Deals 25 damage to all enemies, plus extra damage to enemies stopped by cursed speech.',
        kind: 'attack',
        targetRule: 'enemy-all',
        classes: ['Special', 'Ranged', 'Instant'],
        cooldown: 2,
        ...
        effects: [
          ...
          { type: 'damageFiltered', power: 10, requiresTag: 'dont-move', target: 'all-enemies', cannotBeCountered: true, cannotBeReflected: true },
        ],
      }),
      healSkill({
        id: 'toge-throat-spray',
        name: 'Throat Spray',
        description: 'Heals Toge or one ally for 10 health and grants 10 destructible defense.',
        targetRule: 'ally-single',
        classes: ['Strategic', 'Instant'],
        cooldown: 2,
        energyCost: { random: 1 },
    ...
    ultimate: defendSkill({
      id: 'toge-silence-guard',
      name: 'Cursed Speech Guard',
      description: 'Toge becomes invulnerable for 1 turn.',
      targetRule: 'self',
      classes: ['Strategic', 'Instant', 'Ultimate'],
      cooldown: 4,
      duration: 1,
  ...
  fighter({
    ...
    passiveEffects: [
      definePassive({
        ...
        trigger: 'onAbilityResolve',
        effects: [markerEffect('Type', 2, 'inherit', ['todo-type'])],
        label: 'Besto Friendo',
        description: "When Todo targets an enemy, he marks them as his Type for 2 turns.",
    ...
    abilities: [
      skill({
        ...
        name: 'Brutal Swing',
        description: 'Deals 30 damage to one enemy, plus 10 more if they are affected by Boogie Woogie.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Physical', 'Melee', 'Instant'],
        cooldown: 1,
        ...
        effects: [
          ...
          { type: 'damageFiltered', power: 5, requiresTag: 'todo-type', target: 'inherit' },
        ],
      }),
      skill({
        id: 'todo-boogie-woogie',
        name: 'Boogie Woogie',
        description: 'One enemy deals 10 less damage and cannot become invulnerable. Todo also guards against the next harmful skill.',
        kind: 'utility',
        targetRule: 'enemy-single',
        classes: ['Physical', 'Ranged', 'Instant'],
        cooldown: 2,
        ...
        effects: [
          ...
          { type: 'counter', duration: 1, counterDamage: 10, consumeOnTrigger: true, target: 'self' },
        ],
      }),
      skill({
        id: 'todo-follow-up-assault',
        name: 'Follow-Up Assault',
        description: 'Deals 20 damage to one enemy. Boogie Woogie targets take 15 more damage and have Physical skills sealed.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Physical', 'Melee', 'Instant'],
        cooldown: 2,
    ...
    ultimate: defendSkill({
      ...
      description: "Todo becomes invulnerable for 1 turn and his skills deal 10 more damage during that turn.",
      targetRule: 'self',
      classes: ['Strategic', 'Instant', 'Ultimate'],
      cooldown: 4,
      duration: 1,
  ...
  fighter({
    ...
    passiveEffects: [
      definePassive({
        ...
        description: 'Miwa takes 5 less damage while maintaining discipline.',
    ...
    abilities: [
      skill({
        ...
        name: 'Simple Domain',
        description: 'For 2 turns, Miwa ignores non-damage effects, takes 10 less damage, and enemies cannot become invulnerable.',
        kind: 'utility',
        targetRule: 'self',
        classes: ['Strategic', 'Instant'],
        cooldown: 4,
      ...
      skill({
        id: 'miwa-quick-draw',
        name: 'Quick Draw',
        description: 'Deals 15 damage to one enemy.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Physical', 'Melee', 'Instant'],
        cooldown: 1,
      ...
      skill({
        ...
        name: 'Counter Slash',
        description: 'For 1 turn, Miwa counters harmful skills used on her.',
        kind: 'utility',
        targetRule: 'self',
        classes: ['Physical', 'Melee', 'Instant'],
        cooldown: 2,
        energyCost: { physical: 1 },
        effects: [{ type: 'counter', duration: 1, counterDamage: 25, consumeOnTrigger: false, target: 'self' }],
      }),
    ],
    ultimate: defendSkill({
      id: 'miwa-defensive-stance',
      name: 'Defensive Stance',
      description: 'Miwa becomes invulnerable for 1 turn.',
      targetRule: 'self',
      classes: ['Strategic', 'Instant', 'Ultimate'],
      cooldown: 4,
      duration: 1,
  ...
  fighter({
    ...
    passiveEffects: [
      definePassive({
        ...
        label: 'Disaster Heat',
        description: 'At the start of each turn, Scorched enemies take 5 damage for each stack.',
    ...
    abilities: [
      skill({
        ...
        name: 'Ember Insects',
        description: 'Jogo gains 10 destructible defense and applies 1 Scorched stack to one enemy.',
        kind: 'utility',
        targetRule: 'enemy-single',
        classes: ['Affliction', 'Ranged', 'Instant'],
        cooldown: 1,
      ...
      skill({
        ...
        description: 'All enemies gain 1 Scorched stack.',
        kind: 'utility',
        targetRule: 'enemy-all',
        classes: ['Affliction', 'Ranged', 'Instant'],
        cooldown: 1,
      ...
      skill({
        ...
        description: 'All enemies take 5 damage for each Scorched stack, then lose all Scorched stacks.',
        kind: 'attack',
        targetRule: 'enemy-all',
        classes: ['Affliction', 'Ranged', 'Instant'],
        cooldown: 2,
    ...
    ultimate: defendSkill({
      id: 'jogo-molten-husk',
      name: 'Molten Husk',
      description: 'Jogo becomes invulnerable for 1 turn and counters harmful attacks with heat.',
      targetRule: 'self',
      classes: ['Strategic', 'Instant', 'Ultimate'],
      cooldown: 4,
      duration: 1,
  ...
  fighter({
    ...
    passiveEffects: [
      definePassive({
        ...
        trigger: 'onRoundStart',
        effects: [{ type: 'shield', amount: 10, label: 'Natural Body', tags: ['natural-body'], target: 'self' }],
        label: 'Natural Body',
        description: 'At the start of each turn, Hanami refreshes 10 destructible defense.',
    ...
    abilities: [
      skill({
        ...
        name: 'Root Snare',
        description: 'Deals 15 damage. The target deals 15 less damage and cannot reduce damage for 1 turn.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Physical', 'Ranged', 'Instant'],
        cooldown: 1,
      ...
      skill({
        ...
        description: 'Deals 20 damage and leaves a bud that makes the target take more damage.',
        kind: 'attack',
        targetRule: 'enemy-single',
        classes: ['Physical', 'Ranged', 'Instant'],
        cooldown: 2,
      ...
      skill({
        ...
        description: 'Deals 15 damage to all enemies. For 2 turns, enemies take 5 more damage and deal 5 less damage.',
        kind: 'attack',
        targetRule: 'enemy-all',
        classes: ['Physical', 'Ranged', 'Instant'],
        cooldown: 3,
    ...
    ultimate: defendSkill({
      ...
      description: 'Hanami becomes invulnerable for 1 turn and counters harmful attacks.',
      targetRule: 'self',
      classes: ['Strategic', 'Instant', 'Ultimate'],
      cooldown: 4,
      duration: 1,
