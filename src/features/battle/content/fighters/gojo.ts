...
export const gojo = fighter({
  ...
  passiveEffects: [
    definePassive({
      ...
      label: 'Infinity',
      description: 'At round start, Gojo becomes invulnerable and ignores non-damage effects unless Infinity is collapsed. The first harmful targeting is blocked, then collapses Infinity for the next round unless Six Eyes Focus is guarding it.',
  ...
  abilities: [
    skill({
      ...
      effects: [
        ...
        markerEffect('Pulled', 2, 'inherit', ['pulled'], { intent: 'harmful' }),
      ...
      effects: [
        {
          ...
          effects: [
            ...
            { type: 'removeModifier', filter: { tags: ['pulled'] }, target: 'inherit', intent: 'harmful' },
