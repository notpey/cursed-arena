...
export const yaga = fighter({
  ...
  abilities: [
    skill({
      ...
      description: 'One ally gains 30 destructible defense for 2 turns and takes 10 less damage while it remains. If that defense is destroyed, the attacker takes 20 damage.',
      kind: 'utility',
      ...
      effects: [
        ...
        modifierEffect('Cursed Corpse: Substitute', 'damageTaken', -10, 2, 'inherit', ['cursed-corpse'], { intent: 'helpful' }),
      ],
    }),
    skill({
      id: 'yaga-cursed-corpse-intercept',
      name: 'Cursed Corpse: Intercept',
      description: 'Yaga guards one ally for 1 turn. Yaga takes 15 less damage, and the guarded ally counters attackers.',
      kind: 'utility',
      targetRule: 'ally-single',
      classes: ['Strategic', 'Ranged', 'Instant', 'Physical'],
      cooldown: 2,
      ...
      effects: [
        modifierEffect('Cursed Corpse: Intercept', 'damageTaken', -15, 1, 'self', ['cursed-corpse-intercept'], { intent: 'helpful' }),
    ...
    skill({
      ...
      description: 'Deals 15 damage and 15 additional piercing damage to one enemy.',
      kind: 'attack',
