...
const mockStats: BattleProfileStats = {
  ...
  experience: 1500,
  level: 18,
  rankTitle: 'Grade 2 Sorcerer',
  experienceToNextLevel: 1600,
  peakExperience: 2300,
  peakLevel: 22,
  peakRankTitle: 'Semi-Grade 1 Sorcerer',
  ladderRank: null,
  wins: 10,
  losses: 5,
  matchesPlayed: 15,
...
const mockEntry: MatchHistoryEntry = {
  ...
  rounds: 3,
  experienceDelta: 0,
  experienceBefore: 1500,
  experienceAfter: 1500,
  levelBefore: 18,
  levelAfter: 18,
  rankTitleBefore: 'Grade 2 Sorcerer',
  rankTitleAfter: 'Grade 2 Sorcerer',
